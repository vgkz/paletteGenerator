...
-- a component of RGB colors is an Int
...
-- Definition of the three primary colors
red :: RGB
red   = RGB 1 0 0
green :: RGB
green = RGB 0 1 0
...
mainfunc = do
            ...
            inp <- getLine
            let seed = read inp
            let randomColors = runStateGen_ (mkStdGen seed) (samplenRGB 1000)
            let out = kMeans [red, green, blue] randomColors
